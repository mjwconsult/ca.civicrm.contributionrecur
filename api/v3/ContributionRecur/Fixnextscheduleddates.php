...
/**
 * ContributionRecur.Fixnextscheduleddates API specification
 *
 * @param array $spec description of fields supported by this API call
 * @return void
 * @see http://wiki.civicrm.org/confluence/display/CRM/API+Architecture+Standards
 */
function _civicrm_api3_contribution_recur_fixnextscheduleddates_spec(&$spec) {
...
/**
 * ContributionRecur.Fixnextscheduleddates API
 * @param array $params
 *
 * @return array|void
 ...
 */
function civicrm_api3_contribution_recur_fixnextscheduleddates($params) {
  ...
  $recurIDsUpdated = $recurGenerate->fixNextScheduledDates($params['contribution_recur_id'] ?? NULL);
  return civicrm_api3_create_success($recurIDsUpdated, $params, 'ContributionRecur', 'Fixnextscheduleddates');
}
